...
const BOULANGERIE_RECIPES = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Salage : ajouter le sel fin et pétrir pendant 2 min en vitesse 1 (attention, pâte collante).',
      'Pointage : repos en bac de 1h30 à 24°C.',
      'Division : diviser en pâtons de 450g et bouler fermement.',
      'Apprêt : placer sur couches farinées de seigle pendant 1h15.',
      'Cuisson : inciser profondément en damier, cuire à 220°C pendant 35 min.'
    ]
  },
  {
    id: 'pain-cereales',
    name: 'Pain aux Céréales et Graines',
    category: 'Boulangerie',
    portions: 5,
    prepTime: 30,
    cookTime: 30,
    ...
    steps: [
      ...
      'Pétrissage : pétrir la farine de céréales, l\'eau, le levain, la levure et le sel 8 min en vitesse 1.',
      'Ensemencement : ajouter le restant de graines torréfiées en fin de pétrissage en vitesse 1.',
      'Pointage : laisser pointer la pâte pendant 1h45 à 24°C avec un rabat à mi-parcours.',
      'Façonnage : diviser en pâtons de 400g, façonner en batards longs, humidifier le dessus et rouler dans le restant de graines.',
      'Apprêt : déposer sur couches, reposer 1h15 à 24°C.',
      'Cuisson : grigner longitudinalement, cuire à 230°C avec buée pendant 30 min.'
    ]
  },
  {
    id: 'ciabatta',
    name: 'Ciabatta (Pain Italien)',
    category: 'Boulangerie',
    portions: 6,
    prepTime: 30,
    cookTime: 22,
    ...
    steps: [
      ...
      'Pétrissage : ajouter la levure, pétrir en vitesse 1. Ajouter le sel, puis verser le restant d\'eau petit à petit (bassinage) et enfin l\'huile d\'olive.',
      'Fermentation & Rabats : repos de 3h à 26°C. Effectuer un rabat directement dans le bac huilé toutes les 45 min.',
      'Détaillage : verser la pâte sur un plan de travail abondamment fariné, détailler des rectangles (sans dégazer).',
      'Apprêt : laisser reposer sur plaques farinées pendant 45 min.',
      'Cuisson : enfourner à 230°C avec injection de buée pendant 22 min.'
    ]
  },
  {
    id: 'fougasse-olives',
    name: 'Fougasse Provençale aux Olives',
    category: 'Boulangerie',
    portions: 4,
    prepTime: 30,
    cookTime: 18,
    ...
    steps: [
      ...
      'Incorporation : incorporer les olives noires coupées en morceaux et les herbes de Provence à vitesse lente.',
      'Pointage : reposer la pâte 1h30 sous bâche.',
      'Division & Façonnage : diviser en pâtons de 400g, abaisser en triangles, pratiquer des incisions en forme de feuille et les écarter avec les doigts.',
      'Apprêt : laisser pousser sur plaques de cuisson pendant 45 min à 25°C.',
      'Cuisson & Finition : badigeonner d\'huile d\'olive, cuire à 220°C pendant 18 min. Lustrer à l\'huile d\'olive à la sortie.'
    ]
  },
  {
    id: 'pain-viennois',
